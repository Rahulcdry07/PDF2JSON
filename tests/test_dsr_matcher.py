...
def sample_database():
    ...
    sample_data = [
        (
            ...
            "Chapter 15",
            "Brick Work",
            "Brick work in superstructure with common burnt clay",
            "Cum",
            502.75,
            "Vol 1",
            120,
        ...
        (
            ...
            "Chapter 16",
            "Plastering",
            "Cement plaster 12mm thick in single coat",
            "Sqm",
            180.50,
            "Vol 1",
            145,
        ...
        (
            ...
            "Chapter 20",
            "Painting",
            "Painting with oil paint two coats",
            "Sqm",
            95.25,
            "Vol 1",
            189,
...
def structured_input_file():
    ...
    with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
        data = {
            "metadata": {"type": "input_items", "project": "Test Project", "date": "2024-01-01"},
            "items": [
                {
                    "code": "15.12.2",
                    "clean_code": "15.12.2",
